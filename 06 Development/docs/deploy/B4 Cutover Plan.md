...
Source audit четырёх приоритетных визовых routes выполнен 29 июля 2026 года и
зафиксирован в `docs/B4 Visa Source Audit.md`. Найдены расхождения, поэтому
этот precondition пока не выполнен.
