...
export function AdminApp() {
  ...
  async function loadData(filters: AuditFilters = auditFilters) {
    ...
    if (tab === "inventory" || tab === "clients" || tab === "visa-archive" || tab === "managers") { setData({ items: [] }); return; }
    setData(null);
    try {
