...
export const destinations: readonly Destination[] = [
  {
    ...
    services: [
      ...
      },
      {
        ...
        name: "Обмен валюты",
        icon: "↔",
        summary: "Обмен USDT на наличные IDR и другие направления обмена.",
        children: [
          {
            id: "usdt-idr",
            name: "Калькулятор USDT → IDR",
            icon: "=",
            summary: "Расчёт суммы к выдаче по актуальному курсу.",
            note: "Финальный курс подтверждает менеджер перед обменом.",
            content:
              "Введите сумму USDT в калькуляторе бота или напишите менеджеру. Итоговая сумма зависит от актуального курса и подтверждается перед обменом.",
          },
          {
            id: "other-exchange",
            name: "Другой обмен",
